...
export default function MyProfilePage() {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-02">
      ...
      {/* 흰색 카드 */}
      <div className="flex-1 bg-white rounded-t-2xl overflow-y-auto">
        <div className="flex flex-col items-center px-5 pt-14 pb-6 gap-5">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            {/* 상태 메시지 */}
            <div className="px-2.5 py-2.5 bg-surface-subtle rounded-2xl">
          ...
          {/* 개인정보 섹션 */}
          <div className="w-full flex flex-col gap-4 pt-3 border-t border-line-subtle">
